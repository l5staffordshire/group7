...
<form  class="Form" action="updatedb.php" method="post" enctype="multipart/form-data">
<fieldset>
...
<body>
    ...
    <div class="main-content">
        ...
        <form class="form-register" method="post" action="updatedb.php">
            ...
            <div class="form-register-with-email">
                ...
                <div class="form-transparent-background">
                    ...
                    <div class="form-row">Next Of Kin<br/>
                        <label>
                            <span>First Name </span>
                ...
                <a href="form-login.html">Already have an account? Login here &rarr;</a>
